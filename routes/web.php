...
Route::middleware(['auth', 'active.user'])->group(function () {
    ...
    Route::post('/streaks/{id}/delete', [StreakController::class, 'delete'])->name('streaks.delete');
    Route::post('/streaks/{id}/mark-date', [StreakController::class, 'markDate'])->name('streaks.mark-date');
